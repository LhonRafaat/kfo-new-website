          ...
          <div>
            ...
            <blockquote className="mt-5 max-w-xl">
              <p className="body-lg relative pl-6 leading-relaxed">
                ...
                Kurdistan Film Commission is the newly established non-profit film commission in the
                Kurdistan region of Iraq. The northern region of Iraq is well-known for its rich
                history, beautiful landscapes, charming cities, mountains, and vibrant cultural
                heritage.
              </p>
            </blockquote>
            <div className="mt-8">
